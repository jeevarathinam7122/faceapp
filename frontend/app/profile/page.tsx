...
import { Trash2, ImageOff, LayoutGrid, Heart, MessageCircle, Send, X, User } from "lucide-react"
...
export default function ProfilePage() {
    ...
    const fetchPosts = async () => {
        ...
        try {
            const t = localStorage.getItem("token")
            const r = await axios.get(`${API_BASE}/posts/me`, {
        ...
        <>
            ...
            <div style={{ paddingTop: '80px', minHeight: '100vh', maxWidth: '640px', margin: '0 auto', padding: '80px 16px 60px' }}>
                ...
                <div style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <User style={{ color: '#0ea5e9', width: 22, height: 22 }} />
                    <h1 style={{ fontSize: '1.4rem', fontWeight: 700, color: '#0f2942', margin: 0 }}>Your Profile</h1>
                </div>
